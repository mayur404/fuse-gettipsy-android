...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.113"), 12124)}, "/Users/bucky/Documents/Github/fuse-gettipsy-android/gettipsy/gettipsy.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("gettipsy");
}
}
}
